		   		  ...
		   		  <div class="row">
				       ...
				       <div class="col-md-6">
					   		<div id="div01" class="form-group">
					                    ...
					                    <label class="col-form-label" for="inputSuccess"> ¿Tiene Fiebre? (MAYOR DE 38ºC)
					                      </label>
				       ...
				       <div class="col-md-6">
					   		<div id="div01" class="form-group">
					                    ...
					                    <label class="col-form-label" for="inputSuccess"> ¿Ha tenido contacto estrecho con algún paciente positivo confirmado?
					                      </label>
		   			...
		   			<div class="row">
				   		<div class="col-md-6">
					   		<div class="form-group">
					                  <label class="col-form-label" for="inputSuccess"> ¿Tiene sintomatología gastrointestinal?
					                      </label>
    		...
    		<div class="row">
				       ...
				       <div class="col-md-6">
					   		<div id="div01" class="form-group">
					                    ...
					                    <label style="width: 100%;" class="col-form-label" for="inputSuccess"> ¿Tiene Fiebre? (MAYOR DE 38ºC)
					                      </label>
				       ...
				       <div class="col-md-6">
					   		<div id="div01" class="form-group">
					                    ...
					                    <label style="width: 100%;" class="col-form-label" for="inputSuccess"> ¿Ha tenido contacto estrecho con algún paciente positivo confirmado?
					                      </label>
		   			...
		   			<div class="row">
				   		<div class="col-md-6">
					   		<div class="form-group">
					                  <label style="width: 100%;" class="col-form-label" for="inputSuccess"> ¿Tiene sintomatología gastrointestinal?
					                      </label>
	...
	$.ajax({  
		...
		success:function(response){
			if(response.dataMensaje!=-1){ 
				...
				tablaCiudadanos();
				$("#id_nuevo_triaje").modal("hide");
				//alert("Se registró al ciudadano con su triaje");
